...
class MessagesClient {
    ...
    uploadAudio(audioPath: string, duration: number, conversation_id: number) {
        ...
        return this.httpClient.upload('messages', file, { conversation_id: conversation_id.toString(), duration: duration.toString() })
